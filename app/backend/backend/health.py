...
@extend_schema(summary='Liveness probe', responses=OpenApiTypes.OBJECT, tags=['Auth'], auth=[])
@api_view(['GET'])
...
@extend_schema(summary='Readiness probe (DB + cache)', responses=OpenApiTypes.OBJECT, tags=['Auth'], auth=[])
@api_view(['GET'])
@permission_classes([AllowAny])
